...
(function (factory) {
    ...
    var defaultOpts = {
        ...
        showAlpha: false,
        theme: "sp-light",
        palette: [ ["#ffcaba", "#fda08c", "#fb7661", "#f8533b", "#f23a2c", "#e5342c", "#d73631", "#c22a32", "#9a0b2c"],
    ...
    function spectrum(element, o) {
        ...
        function show() {
            ...
            //kyung 추가
            $('.sp-container .ddp-btn-close').bind("click.spectrum", clickout);
            container.find('.ddp-btn-line').removeClass('ddp-selected');
            $('.sp-picker-container').hide();
            $('.sp-container').removeClass('ddp-picker');
    ...
    */
    function getOffset(picker, input) {
        ...
        // var viewWidth = docElem.clientWidth;
        ...
        //     Math.abs(offset.left + dpWidth - viewWidth) : 340);
