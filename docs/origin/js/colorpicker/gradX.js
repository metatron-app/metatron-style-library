...
if (typeof jQuery.fn.draggable === "undefined") {
    ...
    (function($) {
        ...
        $.fn.draggable = function() {
            ...
            ele.style.top = "121px";
            Drag.init(ele, null, -4, 216, 86, 86);
            return this;
        };
    ...
    gradx = {
        ...
        load_info: function(ele) {
            ...
            if (this.slider_ids.indexOf(ele.id) > -1) { //javascript does not has # in its id
                ...
                if (parseInt(left) > 0 && parseInt(left) < 220) {
        ...
        add_slider: function(sliders) {
            ...
            for (k in obj) {
                ...
                var delta = -4; //range: 26px tp 426px
                ...
                slider = "<div class='wrap-grax-slider'><div class='gradx_slider' id='" + id + "'><input type='text' id='custom2' class='ddp-user'></div></div>";
            ...
            for (var i = 0, len = this.slider_ids.length; i < len; i++) {
                ...
                gradx.gx('#' + this.slider_ids[i]).draggable({
                    ...
                    drag: function() {
                        ...
                        if (parseInt(left) > 26 && parseInt(left) < 220) {
                            gradx.gx("#gradx_slider_info") //info element cached before
                                    .css("left", left)
                                    .show();
        ...
        load_gradx: function(id, sliders) {
            ...
            //.hide();
            //this.info.hide();
            this.container_width = 220 //HARDCODE;
